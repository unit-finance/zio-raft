...
package object protocol {
   ...
   * 
   * Sessions are durable and persist across client reconnections and leader changes.
   * The server generates UUIDs to ensure global uniqueness across the cluster.
   */
   ...
   * 
   * Capabilities are key-value pairs that describe what functionality
   * a client supports, used by the server for work dispatch routing.
   */
