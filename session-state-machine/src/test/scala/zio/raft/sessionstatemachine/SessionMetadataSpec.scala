 ...
 * 
 * Tests the SessionMetadata case class structure after removing redundant sessionId field.
 * sessionId is now stored only in the HMap key, not duplicated in the value.
 */
