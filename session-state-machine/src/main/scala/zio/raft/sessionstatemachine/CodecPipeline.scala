...
/** Streaming codec decoder for ZStream.
  *
  * Provides a ZPipeline that decodes a stream of bytes using a scodec Codec, handling partial data and backpressure
  * properly. Works on Chunks for efficiency.
  */
